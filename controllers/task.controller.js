...
exports.getTask = (req, res) => {
    ...
    User.findById(userId, (err, user) => {
        ...
        Task.getTaskForUser(userId, (err, task) => {
            ...
            // Check if there's an active lucky order plan for this user
            InjectionPlan.findByUserIdAndOrder(userId, (luckyErr, luckyPlan) => {
                if (luckyErr) {
                ...
                if (isLuckyOrder && !task) {
                    ...
                    task = {
                        ...
                        image_url: 'https://via.placeholder.com/150?text=Lucky+Order', // Placeholder image
